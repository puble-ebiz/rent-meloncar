...
function bSyncShoping() {
  browserSync.init({
    // watch: true,
    port: 3050,
    startPath: "./views/shoping/",
    server: {
      baseDir: "./dist",
    },
  });
...
function bSyncLanding() {
  browserSync.init({
    // watch: true,
    port: 3050,
    startPath: "./views/landing/meloncar/",
    server: {
      baseDir: "./dist",
    },
  });
...
exports.shop = parallel(
  series(parallel(template), css, js, img, etc, bSyncShoping),
  watching
);
exports.land = parallel(
  series(parallel(template), css, js, img, etc, bSyncLanding),
  watching
);
exports.master = parallel(
  series(parallel(template), css, js, img, etc, bSyncMaster),
  watching
);
exports.default = parallel(bSync, watching);
exports.test = series(
