...
exports.shop = parallel(series(parallel(template), sassDev, css, js, img, etc, bSyncShoping), watching);
exports.land = parallel(series(parallel(template), sassDev, css, js, img, etc, bSyncLanding), watching);
exports.master = parallel(series(parallel(template), sassDev, css, js, img, etc, bSyncMaster), watching);
exports.default = parallel(bSync, watching);
